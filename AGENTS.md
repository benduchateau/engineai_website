# AGENTS.md — Engine AI Website
**Project:** engineai.co.nz
**Last updated:** March 2026
**Inherits from:** ~/.Codex/AGENTS.md
...
6. What We Deploy — 4 product cards (Codex, Copilot, OpenClaw, Bespoke Builds)
7. Why Now (The Window)
8. Contact / CTA
[Footer]

Sub-pages:
/Codex   — Codex Co-Work, Chat, Code deployment service
...
- What We Deploy — 2x2 card grid with product logos (Codex, Copilot, OpenClaw, Bespoke Builds)
